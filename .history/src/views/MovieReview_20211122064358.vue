...
export default {
  ...
  data: function() {
    ...
    return {
      index: index,
      reviewForm: {
        title: index !== undefined ? this.movieData.review_set[reviewIdx].title : "",
        content: index !== undefined ? this.movieData.review_set[reviewIdx].content : "",      
        rank: index !== undefined ? this.movieData.review_set[reviewIdx].rank : 0
      }
    }
  },
  methods: {
