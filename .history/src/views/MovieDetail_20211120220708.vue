  ...
  <div class="container-fluid">
    ...
    <div>
      ...
      <div class="list-group accordion">
        <div v-for="review in reviews" :key="review.id" class="list-group-item list-group-item-action accordion-item">
          <h3 class="accordion-header">
            <button class="accordion-button" type="button" data-bs-toggle="collapse" :data-bs-target="review.id" aria-expanded="true" :aria-controls="review.id">
              <span>작성자: {{ review.userName }}</span> |
              <span>제목: {{ review.title }}</span>            
            </button>
          </h3>
          <div id=review.id class="accordion-collapse collapse show">
